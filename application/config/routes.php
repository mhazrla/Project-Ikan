...
$route['detail/(:num)'] = 'MonitoringController/detail/$1';
$route['delete/(:num)'] = 'MonitoringController/deleteLogdata/$1';
$route['export/(:num)'] = 'MonitoringController/export/$1';

$route['auth'] = 'AuthController/index';
$route['auth/login'] = 'AuthController/index';
$route['auth/registration'] = 'AuthController/registration';
$route['auth/logout'] = 'AuthController/logout';

$route['chart/(:num)'] = 'ChartController/getChart/$1';
